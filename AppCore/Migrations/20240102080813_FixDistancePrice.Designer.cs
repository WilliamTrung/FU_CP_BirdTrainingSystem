...
namespace AppCore.Migrations
{
    ...
    [Migration("20240102080813_FixDistancePrice")]
    partial class FixDistancePrice
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Models.Entities.BirdTrainingCourse", b =>
                {
                    ...
                    b.Property<int?>("TrainingCourseCheckOutPolicyId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("TrainingCourseCheckOutPolicyId");
            ...
            modelBuilder.Entity("Models.Entities.ConsultingTicket", b =>
                {
                    ...
                    b.Property<decimal?>("ConsultingPricePolicyCalculate")
                    ...
                    b.Property<decimal?>("DistancePriceCalculate")
                        .HasColumnType("numeric");
            ...
            modelBuilder.Entity("Models.Entities.Trainer", b =>
                {
                    ...
                    b.Property<bool>("ConsultantAble")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("Models.Entities.TrainingCourseCheckOutPolicy", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("TrainingCourseCheckOutPolicies");
                });
            ...
            modelBuilder.Entity("Models.Entities.BirdTrainingCourse", b =>
                {
                    ...
                    b.HasOne("Models.Entities.TrainingCourseCheckOutPolicy", "TrainingCourseCheckOutPolicy")
                        .WithMany("BirdTrainingCourses")
                        .HasForeignKey("TrainingCourseCheckOutPolicyId");
                    ...
                    b.Navigation("TrainingCourseCheckOutPolicy");
                });
