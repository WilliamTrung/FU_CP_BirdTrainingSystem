    ...
    .AddJsonOptions
               (
                   x =>
                   {
                       ...
                       x.JsonSerializerOptions.Converters.Add(new StringEnumConverter<Models.Enum.AdministrativeRole>());
                       ...
                       x.JsonSerializerOptions.Converters.Add(new StringEnumConverter<Models.Enum.TrainingCourse.Status>());
                       x.JsonSerializerOptions.Converters.Add(new StringEnumConverter<Models.Enum.TCCheckOutPolicy.Status>());
                       x.JsonSerializerOptions.Converters.Add(new StringEnumConverter<Models.Enum.Timetable.AbsentOption>());
...
builder.AddTrainingCourseHostedService();
